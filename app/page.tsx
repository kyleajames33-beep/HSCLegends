...
export default function Home() {
  return (
    <main className="flex flex-1 flex-col px-6 pt-14 pb-10 w-full max-w-md md:max-w-5xl mx-auto">
      <div className="flex-1 flex flex-col">
        <header className="md:text-center">
          ...
          <h1 className="mt-2 text-[2.6rem] md:text-6xl font-extrabold leading-[1.05] text-ink">
        ...
        <div className="mt-6 grid gap-x-8 gap-y-4 md:grid-cols-2 md:items-start">
          {/* Daily core */}
          ...
          <div className="space-y-3">
            ...
            <Link href="/season" className="lg-card flex items-center justify-between px-4 py-3.5 transition active:translate-y-0.5">
